...
public class UserFrom_OrderSell extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_from__order_sell);
        ...
        rproid.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                try {
                    ...
                    Toast.makeText(UserFrom_OrderSell.this, "ຮັບເອົາຊຶ່ສິນຄ້າສຳເລັດ", Toast.LENGTH_SHORT).show();

                }catch (Exception e){
                    Toast.makeText(UserFrom_OrderSell.this, "ລະຫັດນິບໍມີຢູໃນຖານຂໍ້ມູນຂອງສິນຄ້າ", Toast.LENGTH_SHORT).show();
                }
            }
                ...
                if (rproid.getText().toString().isEmpty()){
                    ...
                    try {
                        ...
                        while (cursor.moveToNext()){
                            ...
                            if (proQty < orqty){
                                Toast.makeText(UserFrom_OrderSell.this, "ຈຳນວນສີນຄ້ານິ້ບໍພຽງພໍຂາຍອອກ", Toast.LENGTH_SHORT).show();
                                ...
                                if (isInserted = true) {
                                    Toast.makeText(UserFrom_OrderSell.this, "ຂາຍສຳເລັດແລັວ", Toast.LENGTH_SHORT).show();
                                    try {
                                        myDb.AddQtyProductssell(rqty.getText().toString().trim(), rproid1);
                                    } catch (Exception e) {
                                        Toast.makeText(UserFrom_OrderSell.this, "ອັບເດັດຂໍ້ມູນຈຳນວນສິນຄ້າບໍສຳເລັດແລັວ ?", Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                                    Toast.makeText(UserFrom_OrderSell.this, "ຂາຍບໍສຳເລັດ", Toast.LENGTH_SHORT).show();
                                }
