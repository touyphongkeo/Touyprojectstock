...
public class UsersRecives extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_users_recives);
        ...
        proid.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                try {
                    ...
                    Toast.makeText(UsersRecives.this, "ຮັບເອົາຊຶ່ສິນຄ້າສຳເລັດ", Toast.LENGTH_SHORT).show();

                }catch (Exception e){
                    Toast.makeText(UsersRecives.this, "ລະຫັດນິິບໍໃນລະບົບສິນຄ້າເຈົ້າ  ?", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onClick(View v) {
                if (proid.getText().toString().isEmpty()){
                    ...
                    if (isInserted1 = true) {
                        ...
                        Toast.makeText(UsersRecives.this, "ບັນທຶກສຳເລັດແລັວ ?", Toast.LENGTH_SHORT).show();
                        try {
                            myDb.AddQtyProducts(qty.getText().toString().trim(), proid1);
                        } catch (Exception e) {
                            Toast.makeText(UsersRecives.this, "ອັບເດັດຂໍ້ມູນສິນຄ້າບໍສຳເລັດແລັວ ?", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(UsersRecives.this, "ບັນທຶກຂໍ້ມູນບໍສຳເລັດກະລຸນາກວດສອບລະບົບກອນ", Toast.LENGTH_SHORT).show();
                    }
