...
public class products extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Button btnsaved, btnshow,btnupdate,btndelete;//ລະຫັດຂອງປຸ່ມບັນທຶກ
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ຮັບຈາກການຂຽນເພືອໄປຫາຟ່າຍ UPDATE_PRODUCT

        btnupdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent nextpage = new Intent(getApplicationContext(), Update_products.class);
        ...
        btndelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent nextpage = new Intent(getApplicationContext(), ProdustDelete.class);
                startActivity(nextpage);
            }
        });
            ...
            public void onClick(View v) {
                if (proname.length() == 0) {
                   ...
                   // Toast.makeText(products.this, "ເລືອກລະຫັດປະເພດກ່ອນ!!", Toast.LENGTH_SHORT).show();
                    ...
                    if (Isaved = true) {
                        Toast.makeText(products.this, "ບັນທຶກສຳເລັດແລ້ວ!!", Toast.LENGTH_SHORT).show();
                    } else
                        Toast.makeText(products.this, "ບັນທຶກຍັງບໍທັນສຳເລັດແລ້ວ!!", Toast.LENGTH_SHORT).show();
